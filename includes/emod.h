...
#include "emod\\drv_tv.h"
#include "emod\\drv_tcon.h"
...
#define EMOD_TYPE_DRV_TV         		0x0e        /* matrix key driver    */
#define EMOD_TYPE_DRV_MCU		      	0x0f	         /* DSA */	        //add by libaiao
