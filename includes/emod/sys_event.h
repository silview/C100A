...
#define KPAD_LINEIN_PLUGIN		0x208	//wqx 20130409
#define KPAD_LINEIN_PLUGOUT	0x209
#define KPAD_VOICEUP        0x20c
#define KPAD_VOICEDOWN      0x20d
#define KPAD_POWER          0x210
#define KPAD_POWEROFF       0x211
#define KPAD_MUTE		0x212   //cai++
#define KPAD_PHOTO		0x213
#define KPAD_MUSIC		0x214
#define KPAD_MOVIE		0x215
#define KPAD_PAUSE		0x216
#define KPAD_SETTING	0x217
#define KPAD_CALENDAR	0x21c
#define KPAD_FM			0x21d
#define KPAD_MEDIA_PRE		0x220
#define KPAD_RECORD	0x221
#define KPAD_MEDIA_NEXT		0x222
#define KPAD_IR_LEFT	0x223
#define KPAD_IR_RIGHT	0x224
#define KPAD_IR_UP		0x225
#define KPAD_IR_DOWN	0x226
#define KPAD_IR_VOICEUP	0x227
#define KPAD_IR_VOICEDOWN	0x22c
#define KPAD_IR_POWER	0x22d
#define KPAD_IR_TVOUT	0x22E
#define KPAD_REPLACE_ENTER		0x22F //cai++ for longenter is poweroff  use this key message replace it

#define KPAD_NUM0		0x230
#define KPAD_NUM1		0x231
#define KPAD_NUM2		0x232
#define KPAD_NUM3		0x233
#define KPAD_NUM4		0x234
#define KPAD_NUM5		0x235
#define KPAD_NUM6		0x236
#define KPAD_NUM7		0x237
#define KPAD_NUM8		0x238
#define KPAD_NUM9		0x239
#define KPAD_NUM_CLR		0x23A

#define KPAD_LR		  0x23B
#define KPAD_MODE		0x23C
#define KPAD_STORE_UP		0x23d
#define KPAD_STORE_UP_PLAY	0x23e
#define KPAD_SCR_ONOFF	0x23f
#define KPAD_TV			0x240
#define KPAD_IR_KOK		0x241
