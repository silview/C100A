...
__bool RDA5807P_ValidStop(__u16 freq)
{
	...
	//__msg("............%d,%d\n",freq,RDA5807P_reg_data[2]);

	//check FM_TURE
	if((RDA5807P_reg_data[2] &0x01)==0) falseStation=1;
	/*
	if((RDA5807P_reg_data[2] &0x01)&&(RDA5807P_reg_data[2] <0x2a)) //0x2b//0x2c//0x2d//0x2e
		{
		//__msg("....23......RDA5807P_reg_data_2= %x\n",RDA5807P_reg_data[2]);
		//__msg("........4646...........................\n");
		falseStation=1;
		}
	*/
	...
	if(freq==1080) falseStation=1;

	if(freq==870) falseStation=1;
...
__s32  fm_init(void)
{
   ...
   __u8 i 						= 0;
...
#if 0
    	{
    		...
    		//RDA5807N_initialization_reg[11] bit2:7代表灵敏度，原来是110， 修改后为100
