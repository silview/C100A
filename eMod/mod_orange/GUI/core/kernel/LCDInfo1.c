...
#if GUI_NUM_LAYERS > 1
  int LCD_GetXSize_1(void)        { return Screen_Context.LCDXSize[GUI_Context.SelLayer]; }
  int LCD_GetYSize_1(void)        { return Screen_Context.LCDYSize[GUI_Context.SelLayer]; }
