...
{	
	...
	dsk_display_lcd_set_duty			,
	dsk_display_lcd_get_duty			,
	//#if ADD_LCD_BRIGHT_SATURATION_MORE_SET
	dsk_display_set_panel_bright		,
	dsk_display_get_panel_bright		,
	...
	dsk_display_set_lcd_vcom				,
	dsk_display_get_lcd_vcom				,	
	...
	dsk_power_onoff_ctl					,
	dsk_rec_onoff  						,
	dsk_set_record_is_recording			,
	dsk_get_record_is_recording			,
	NULL								,
	NULL								,
	NULL								,
	NULL								,
	...
	dsk_radio_rcv_set_search_cb,                    //add by libaiao,2011.11.16	
	dsk_radio_rcv_auto_search,		
	dsk_radio_rcv_get_cur_freq,			
	dsk_radio_rcv_set_search_mode,
	dsk_radio_get_search_flag,						//add by cky
 	dsk_radio_set_search_flag,				//add by cky
	dek_radio_set_FM1_3,			//add by Kingvan
	dek_radio_get_FM1_3,			//add by Kingvan
	dek_radio_set_FM1_3_ID,			//add by Kingvan
	dsk_radio_rcv_search_stop,		//add by Kingvan
	...
	dsk_radio_rcv_get_preview_flag				,	
	dsk_radio_rcv_is_searching					,
	
	/////////echo begin
	dsk_audio_echo_open		              ,
	dsk_audio_echo_close		            ,
	dsk_audio_echo_set_mic_pre_gain	    ,
	dsk_audio_echo_set_mic_gain		      ,
	dsk_audio_echo_gain_incr		        ,
	dsk_audio_echo_gain_decr		        ,
	dsk_audio_echo_set_delay_num		    ,
	dsk_audio_echo_set_delay_time		    ,
	dsk_audio_echo_enable_ec		        ,
	dsk_audio_echo_set_pitch_mode		    ,
	dsk_audio_echo_is_open                  ,
	dsk_audio_echo_enable_output            ,
	/////////echo end
};
