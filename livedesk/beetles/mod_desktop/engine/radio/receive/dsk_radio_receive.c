...
#ifdef	FM_SEARCH_PREVIEW
					//搜台成功后, 预览播放; Ethan;
					{
						dsk_radio_rcv->preview_flag = 1;
...
//
__s32 dsk_radio_rcv_get_preview_flag(void)
{
	return dsk_radio_rcv->preview_flag ;
}


__s32 dsk_radio_rcv_is_searching(void)
{
	return dsk_radio_rcv->search_flag;
}
