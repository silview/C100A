...
//////////////////////////////////////////////////////////////////////////
#define MY_SSET_LAYOUT   sset_layout_480x272
#define MY_SCREEN_SIZE   SCREEN_SIZE_480_272
#define MY_LCD_W         800	//480
#define MY_LCD_H         480	//272

#define TBAR_ITEM_NUM                4	//6

#define TBAR_RT_W                    MY_LCD_W
#define TBAR_RT_H                    56	//46
#define TBAR_RT_X                    0
#define TBAR_RT_Y                    (MY_LCD_H - TBAR_RT_H)-4
...
#define TBAR_ITEM_BMP_W              35
#define TBAR_ITEM_BMP_H              30
...
#define LSTM_BMP_W                   163
#define LSTM_BMP_H                   28
#define LSTM_BMP_X                   0
#define LSTM_BMP_Y                   0

#define LSTM_RT_W                    LSTM_BMP_W
#define LSTM_RT_H                    (LSTM_BMP_H * 8)
#define LSTM_RT_X                    (MY_LCD_W - LSTM_RT_W)
#define LSTM_RT_Y                    136	//36
...
__sset_uipara_t * SSET_Get_Uipara(void)
{
	...
	if( lcd_width == MY_LCD_W && lcd_height == MY_LCD_H )	
	{
