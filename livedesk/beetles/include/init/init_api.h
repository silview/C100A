...
typedef struct INIT_API_ENTRY
{
	...
	__s32 					(*ptr_g_open_screen)				( void );
	__bool					(*ptr_g_screen_is_on)				( void );
...
#define g_open_screen 				(INIT_FUNC_ENTRY->ptr_g_open_screen			)
#define g_screen_is_on 				(INIT_FUNC_ENTRY->ptr_g_screen_is_on			)
