...
{		
	...
	__s32 						(*ptr_dsk_display_lcd_set_duty)				(__s32 duty);
	__s32 						(*ptr_dsk_display_lcd_get_duty)				(void);
//#if ADD_LCD_BRIGHT_SATURATION_MORE_SET
	__s32 					       (*ptr_dsk_display_set_panel_bright)				(__s32  value);
	__s32 						(*ptr_dsk_display_get_panel_bright)				(void);
	__s32 					       (*ptr_dsk_display_set_lcd_constract)				(__s32  value);
	__s32 						(*ptr_dsk_display_get_lcd_constract)				(void);
	__s32 					       (*ptr_dsk_display_set_lcd_saturation)				(__s32  value);
	__s32 						(*ptr_dsk_display_get_lcd_saturation)				(void);
	__s32 					     (*ptr_dsk_display_set_lcd_hue)				(__s32  value);
	__s32 						(*ptr_dsk_display_get_lcd_hue)				(void);
	__s32 					     (*ptr_dsk_display_set_lcd_vcom)				(__s32  value);
	__s32 						(*ptr_dsk_display_get_lcd_vcom)				(void);
    ...
    __s32						(*ptr_dsk_amplifier_onoff) 					(__s32 flag);
    __bool						(*ptr_dsk_amplifier_is_on) 					(void);
    void						(*ptr_dsk_power_onoff_ctl) 					(__s32 flag);
    void						(*ptr_dsk_rec_onoff) 						(__s32 flag);
	void						(*ptr_dsk_set_record_is_recording) 			(__bool val);
	__bool						(*ptr_dsk_get_record_is_recording)			(void);
	...
	__s32						(*ptr_dsk_radio_get_search_flag)				(__u32 *search_flag);//by cky 
	__s32						(*ptr_dek_radio_set_FM1_3)					( __u16 fm1_3_id, __u16 fm_index, __u32 freq );	//add by Kingvan
	__u32						(*ptr_dek_radio_get_FM1_3)					( __u16 fm1_3_id, __u16 fm_index );				//add by Kingvan
	__u16						(*ptr_dek_radio_set_FM1_3_ID)				( __s16 fm1_3_id );								//add by Kingvan
	__s32						(*ptr_dsk_radio_rcv_search_stop)			(void);											//add by Kingvan
	__s32						(*ptr_dsk_radio_set_search_flag)				(__u32 search_flag);//by cky 
    ...
    __s32 						(*ptr_dsk_radio_rcv_save_cur_freq)		    (void);
	...
	__s32 						(*ptr_dsk_radio_rcv_get_preview_flag)		(void);	
	__s32 						(*ptr_dsk_radio_rcv_is_searching)			(void);	
	
	///////////////////////echo begin
	__s32 						 (*ptr_dsk_audio_echo_open) (__audio_rec_user_t type, __s32 auto_clean_buf, __s32 gain);
	__s32 						 (*ptr_dsk_audio_echo_close) (void);
	__s32 						 (*ptr_dsk_audio_echo_set_mic_pre_gain) (__s32 pre_gain);
	__s32 						 (*ptr_dsk_audio_echo_set_mic_gain)(__s32 gain);
	__s32 						  (*ptr_dsk_audio_echo_gain_incr) (void);
	__s32 						  (*ptr_dsk_audio_echo_gain_decr)(void);
	__s32 						(*ptr_dsk_audio_echo_set_delay_num)(__s32 aux);
	__s32 					   (*ptr_dsk_audio_echo_set_delay_time)(__s32 aux);
	__s32 						 (*ptr_dsk_audio_echo_enable_ec)(__s32 aux);
	__s32 						(*ptr_dsk_audio_echo_set_pitch_mode)(__s32 mode, __s32 level);
    __s32                       (*ptr_dsk_audio_echo_is_open)(void);
    __s32                       (*ptr_dsk_audio_echo_enable_output)(__s32 aux);
	///////////////////////echo end
...
#define	dsk_display_lcd_set_duty			(DESKTOP_FUNC_ENTRY->ptr_dsk_display_lcd_set_duty)			
#define	dsk_display_lcd_get_duty			(DESKTOP_FUNC_ENTRY->ptr_dsk_display_lcd_get_duty)			
//#if ADD_LCD_BRIGHT_SATURATION_MORE_SET
#define	dsk_display_set_panel_bright			(DESKTOP_FUNC_ENTRY->ptr_dsk_display_set_panel_bright)			
#define	dsk_display_get_panel_bright			(DESKTOP_FUNC_ENTRY->ptr_dsk_display_get_panel_bright)			
...
#define	dsk_display_set_lcd_vcom					(DESKTOP_FUNC_ENTRY->ptr_dsk_display_set_lcd_vcom)			
#define	dsk_display_get_lcd_vcom					(DESKTOP_FUNC_ENTRY->ptr_dsk_display_get_lcd_vcom)
//#endif
//dsk_display_misc.h
...
#define	dsk_power_onoff_ctl					(DESKTOP_FUNC_ENTRY->ptr_dsk_power_onoff_ctl)				
#define	dsk_rec_onoff						(DESKTOP_FUNC_ENTRY->ptr_dsk_rec_onoff)				
...
#define	dsk_set_record_is_recording			(DESKTOP_FUNC_ENTRY->ptr_dsk_set_record_is_recording)		
#define	dsk_get_record_is_recording			(DESKTOP_FUNC_ENTRY->ptr_dsk_get_record_is_recording)		
...
#define dek_radio_set_FM1_3					(DESKTOP_FUNC_ENTRY->ptr_dek_radio_set_FM1_3)			//add by Kingvan
#define dek_radio_get_FM1_3					(DESKTOP_FUNC_ENTRY->ptr_dek_radio_get_FM1_3)			//add by Kingvan
#define dek_radio_set_FM1_3_ID				(DESKTOP_FUNC_ENTRY->ptr_dek_radio_set_FM1_3_ID)		//add by Kingvan
#define dsk_radio_rcv_search_stop			(DESKTOP_FUNC_ENTRY->ptr_dsk_radio_rcv_search_stop)		//add by Kingvan
...
#define dsk_radio_rcv_get_preview_flag				(DESKTOP_FUNC_ENTRY->ptr_dsk_radio_rcv_get_preview_flag                         )
#define dsk_radio_rcv_is_searching				(DESKTOP_FUNC_ENTRY->ptr_dsk_radio_rcv_is_searching                         )

//////////echo begin
#define dsk_audio_echo_open		                (DESKTOP_FUNC_ENTRY->ptr_dsk_audio_echo_open                            )
#define dsk_audio_echo_close		                (DESKTOP_FUNC_ENTRY->ptr_dsk_audio_echo_close                            )
#define dsk_audio_echo_set_mic_pre_gain		                (DESKTOP_FUNC_ENTRY->ptr_dsk_audio_echo_set_mic_pre_gain                            )
#define dsk_audio_echo_set_mic_gain		                (DESKTOP_FUNC_ENTRY->ptr_dsk_audio_echo_set_mic_gain                            )
#define dsk_audio_echo_gain_incr		                (DESKTOP_FUNC_ENTRY->ptr_dsk_audio_echo_gain_incr                            )
#define dsk_audio_echo_gain_decr		                (DESKTOP_FUNC_ENTRY->ptr_dsk_audio_echo_gain_decr                            )
#define dsk_audio_echo_set_delay_num		                (DESKTOP_FUNC_ENTRY->ptr_dsk_audio_echo_set_delay_num                            )
#define dsk_audio_echo_set_delay_time		                (DESKTOP_FUNC_ENTRY->ptr_dsk_audio_echo_set_delay_time                            )
#define dsk_audio_echo_enable_ec		                (DESKTOP_FUNC_ENTRY->ptr_dsk_audio_echo_enable_ec                            )
#define dsk_audio_echo_set_pitch_mode		                (DESKTOP_FUNC_ENTRY->ptr_dsk_audio_echo_set_pitch_mode                            )
#define dsk_audio_echo_is_open		                (DESKTOP_FUNC_ENTRY->ptr_dsk_audio_echo_is_open                            )
#define dsk_audio_echo_enable_output		                (DESKTOP_FUNC_ENTRY->ptr_dsk_audio_echo_enable_output                            )
